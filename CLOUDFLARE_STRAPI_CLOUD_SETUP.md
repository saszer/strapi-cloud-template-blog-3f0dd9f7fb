# ☁️ Cloudflare Pages + Strapi Cloud Setup
...
```
┌─────────────────────────┐         ┌──────────────────────────┐
│   Cloudflare Pages      │  API    │    Strapi Cloud          │
│   (Next.js Frontend)    │ ──────> │    (Strapi CMS)          │
│   ai2fin.com/blog       │  HTTPS  │    cms.strapiapp.com     │
└─────────────────────────┘         └──────────────────────────┘
```

---

## 📍 Part 1: Strapi Cloud Environment Variables
...
**Include:**
- ✅ Production domain: `https://ai2fin.com`
- ✅ WWW variant: `https://www.ai2fin.com`
- ✅ Cloudflare Pages domain: `https://ai2fin.pages.dev`
- ✅ Preview branches: `https://preview-branch.ai2fin.pages.dev`
...
# 3. Save and Redeploy
Click "Save" → Strapi will automatically redeploy
```
...
✅ **Expected**: Articles load  
❌ **Empty/Error**: Check browser console for errors
...
**Fix:**
1. Go to Strapi Cloud → Settings → Variables
...
3. In Strapi Cloud: Settings → Media Library → Check public access
...
**✅ Once configured, your blog will automatically:**
